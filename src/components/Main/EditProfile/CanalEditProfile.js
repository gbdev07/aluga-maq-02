...
const initErrorField = {
    ...
    tipoParceriaDesejada: undefined,
    numeroAproxClientes: undefined,
    descricaoProdutosServicos: undefined,
...
const CanalEditProfile = (props) => {
    ...
    const getDataProfile = () => {
        axios.get(`${REACT_APP_API_BASE_URL}/search-canal-by-xaccess-token`, {
            headers: {
    ...
    const onSave = () => {
        let errorFieldTemp = {}
        if (cpf.trim().includes('-') && !isValidCpf(cpf.trim())) {
            errorFieldTemp.cpf = 'você deve ter o formato correto - cpf'
        }
        if (cnpj.trim().includes('-') && !cnpjValidation(cnpj.trim())) {
            errorFieldTemp.cnpj = 'você deve ter o formato correto - CNPJ'
        }
        if (cpf.trim() === "" && cnpj.trim() === "") {
            errorFieldTemp.cnpj = 'Este campo é obrigatório: cpf or cnpj'
        }
        if (name.trim() === "") {
        ...
        if ((numeroAproxClientes ? numeroAproxClientes.toString() : "").trim() === "") {
            errorFieldTemp.numeroAproxClientes = 'Este campo é obrigatório'
        }
        if (!segmento) {
        ...
        if(Object.keys(errorFieldTemp).length === 0) {
            setIsLoading(true);
            axios.post(`${REACT_APP_API_BASE_URL}/upsert-canal`, {
                idCanal: userId,
                cpf: cpf,
                cnpj: cnpj,
                name : name,
                ...
                tipoParceriaDesejada : tipoParceriaDesejada,
                numeroAproxClientes : Number(numeroAproxClientes),
                website : website,
            ...
            <div className="FornecedorEditProfile_content">
                <Row>
                    ...
                    <Col xs={24} md={8} lg={8} xl={8}>
                        <div className="FornecedorEditProfile_col1Wrapper">
                            <Row>
                                <Col xs={24} className="FornecedorEditProfile_col">
                                    <div className="FornecedorEditProfile_fieldInputWrapper">
                                        ...
                                        <InputMask
                                            mask="999.999.999-99"
                                            onChange={(event) => {
                                                onChangeData('cpf', event.target.value)
                                            }}
                                            placeholder="CPF"
                                            className="FornecedorEditProfile_fieldInput"
                                            value={cpf}
                                    ...
                                    {
                                        errorField.cpf && <div className="FornecedorEditProfile_fieldError">
                                            {errorField.cpf}
                                        </div>
                                    }
                                    <div className="FornecedorEditProfile_fieldExample">
                                        Exemplo: 000.000.000-99
                                    </div>
                                </Col>
                                <Col xs={24} className="FornecedorEditProfile_col">
                                    <div className="FornecedorEditProfile_fieldInputWrapper">
                    ...
                    <Col xs={24} md={16} lg={16} xl={16}>
                        <Row>
                            <Col xs={24} className="FornecedorEditProfile_col">
                                ...
                                {
                                    errorField.name && <div className="FornecedorEditProfile_fieldError">
                                        {errorField.name}
                                    </div>
                                }
                                <div className="FornecedorEditProfile_fieldExample">
                    ...
                    <Col xs={24} md={8} lg={8} xl={8} className="FornecedorEditProfile_col">
                        <div className="FornecedorEditProfile_fieldInputWrapper">
                            <Input
                                value={anoFundacao}
                                onChange={(event) => {
                                    onChangeData('anoFundacao', event.target.value)
                                }}
                        ...
                        {
                            errorField.anoFundacao && <div className="FornecedorEditProfile_fieldError">
                                {errorField.anoFundacao}
                            </div>
                        }
                        <div className="FornecedorEditProfile_fieldExample">
                            Exemplo: 1992
                    ...
                    <Col xs={24} md={8} lg={8} xl={8} className="FornecedorEditProfile_col">
                        <div className="FornecedorEditProfile_fieldInputWrapper">
                            <Input
                                value={tipoParceriaDesejada}
                                onChange={(event) => {
                                    onChangeData('tipoParceriaDesejada', event.target.value)
                                }}
                                placeholder="Tipo de Parceria Desejada"
                                className="FornecedorEditProfile_fieldInput"
                            />
                            {/*<InputMask*/}
                            {/*    mask="99.999.999/9999-99"*/}
                        ...
                        {
                            errorField.tipoParceriaDesejada && <div className="FornecedorEditProfile_fieldError">
                                {errorField.tipoParceriaDesejada}
                            </div>
                        }
                        <div className="FornecedorEditProfile_fieldExample">
                            Exemplo: Revenda.
                    ...
                    <Col xs={24} md={8} lg={8} xl={8} className="FornecedorEditProfile_col">
                        <div className="FornecedorEditProfile_fieldInputWrapper">
                            <Input
                                value={numeroAproxClientes}
                                onChange={(event) => {
                                    onChangeData('numeroAproxClientes', event.target.value)
                                }}
                        ...
                        {
                            errorField.numeroAproxClientes && <div className="FornecedorEditProfile_fieldError">
                                {errorField.numeroAproxClientes}
                            </div>
                        }
                        <div className="FornecedorEditProfile_fieldExample">
                            Exemplo: 35
                    ...
                    <Col xs={24} md={16} lg={16} xl={16} className="FornecedorEditProfile_col">
                        <div className="FornecedorEditProfile_fieldInputWrapper">
                            <Input
                                value={descricaoProdutosServicos}
                                onChange={(event) => {
                                    onChangeData('descricaoProdutosServicos', event.target.value)
                                }}
                                placeholder="Descrição dos produtos e serviços "
                                className="FornecedorEditProfile_fieldInput"
                            />
                            <div className="FornecedorEditProfile_fieldRequired">
                                {/***/}
                        ...
                        {
                            errorField.descricaoProdutosServicos && <div className="FornecedorEditProfile_fieldError">
                                {errorField.descricaoProdutosServicos}
                            </div>
                        }
                        <div className="FornecedorEditProfile_fieldExample">
                            Exemplo: Trabalhamos com peças e serviços de reparo em equipamentos agrícolas. (Tamanho Máximo: 250 caracteres, Mínimo 10.
                        </div>
                    </Col>
                    <Col xs={24} className="FornecedorEditProfile_col">
                        <div className="FornecedorEditProfile_groupText">
...
export default CanalEditProfile;